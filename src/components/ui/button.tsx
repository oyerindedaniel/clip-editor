...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-3xl text-sm md:text-[0.8rem] font-medium font-sans transition-all duration-250 active:scale-[98%] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface-primary",
  {
    variants: {
      variant: {
        default:
        ...
        tertiary:
          "bg-surface-tertiary text-foreground-subtle hover:bg-surface-secondary",
        pill: "bg-surface-secondary/70 backdrop-blur-sm text-foreground-default hover:bg-surface-hover",
