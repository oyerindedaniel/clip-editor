  ...
  return (
    <MediaPlayerContext.Provider value={contextValue}>
      <RootPrimitive
        ...
        onKeyUp={onKeyUp}
        className={cn(
          "dark relative isolate flex flex-col overflow-hidden rounded-lg bg-surface-secondary outline-none focus-visible:border-primary focus-visible:ring-[3px] focus-visible:ring-primary/50 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_video]:relative [&_video]:object-contain",
      ...
      {children ?? (
        <div className="flex max-w-md flex-col items-center gap-4 px-6 py-8 text-center">
          ...
          <div className="flex flex-col gap-px text-center">
            ...
            <p className="text-balance text-foreground-muted text-sm leading-relaxed">
              {errorDescription}
            </p>
          </div>
  ...
  const SeekSlider = (
    <div data-slot="media-player-seek-container" className="relative w-full">
      ...
      >
        ...
        <SliderPrimitive.Thumb className="relative z-10 block size-2.5 shrink-0 rounded-full bg-primary shadow-sm ring-primary/50 transition-[color,box-shadow] will-change-transform hover:ring-4 focus-visible:outline-hidden focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50" />
      </SliderPrimitive.Root>
      {!withoutTooltip &&
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SliderPrimitive.Thumb className="block size-2.5 shrink-0 rounded-full bg-primary shadow-sm ring-primary/50 transition-[color,box-shadow] will-change-transform hover:ring-4 focus-visible:outline-hidden focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50" />
      </SliderPrimitive.Root>
    </div>
  );
}
...
function MediaPlayerTooltip(props: MediaPlayerTooltipProps) {
  ...
  return (
    <Tooltip {...tooltipProps} delayDuration={tooltipDelayDuration}>
      <TooltipTrigger
        className="text-foreground focus-visible:ring-primary/50"
        asChild
      >
        {children}
      </TooltipTrigger>
      <TooltipContent
        ...
        className="flex items-center gap-2 border px-2 py-1 font-medium text-foreground data-[side=top]:mb-3.5 dark:bg-zinc-900 [&>span]:hidden"
      >
        <p>{tooltip}</p>
