  ...
  return (
    <MediaPlayerContext.Provider value={contextValue}>
      <RootPrimitive
        ...
        onKeyUp={onKeyUp}
        className={cn(
          "dark relative isolate flex flex-col overflow-hidden rounded-lg bg-background outline-none focus-visible:border-primary focus-visible:ring-[3px] focus-visible:ring-primary/50 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_video]:relative [&_video]:object-contain",
